...
// import 'view_shop_item_detail_controller.dart';



class ViewShopItemDetail extends StatefulWidget {
  ...
  @override
  State<ViewShopItemDetail> createState() => _ViewShopItemDetailState();
}

class _ViewShopItemDetailState extends State<ViewShopItemDetail>
    with WidgetsBindingObserver {
  ViewShopItemDetailController controller = Get.put(ViewShopItemDetailController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return GetBuilder<ViewShopItemDetailController>(
