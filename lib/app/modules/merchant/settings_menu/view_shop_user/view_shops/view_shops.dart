...
import 'package:deposits_ecommerce/app/modules/merchant/settings_menu/view_shop_user/view_shops/view_shops_controller.dart';

const String shopsPage = 'shops';

class ViewAsUserShops extends StatefulWidget {
  ...
  @override
  State<ViewAsUserShops> createState() => _ViewAsUserShopsState();
}

class _ViewAsUserShopsState extends State<ViewAsUserShops> with WidgetsBindingObserver {
  ViewShopsController controller = Get.put(ViewShopsController());
  ...
  void initState() {
    ...
    controller.price = controller.priceList.first;
    controller.availability = controller.availabilityList.first;
  }
  ...
  Widget shopDesc() {
    return Container(
      ...
      child: CustomRichTextWidget(
        ...
        onSubtitleTap4: () => returnPolicyOnClick(),
        title5: Strings.pageOr,
        title6: Strings.contactus,
        onSubtitleTap6: () => contactUsOnClick(),
