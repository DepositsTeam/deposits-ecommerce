...
class ContactAddressController extends GetxController {
  ...
  Rx<MerchantData> merchantData = MerchantData().obs;
    ...
    var response = await DioClient()
        .request(context: context,api: '/merchant', method: Method.POST, params: request);
  ...
  void editContactAddress(BuildContext context, ){
